...
num_curr_imgs = length(dir(fullfile(path_to_folder,'*.jpg')));
...
imwrite(img,fullfile(path_to_folder,[num2str(num_curr_imgs+1) '.jpg']));
imwrite(img2,fullfile(path_to_folder,[num2str(num_curr_imgs+2) '.jpg']));
imwrite(img3,fullfile(path_to_folder,[num2str(num_curr_imgs+3) '.jpg']));
imwrite(img4,fullfile(path_to_folder,[num2str(num_curr_imgs+4) '.jpg']));
...
imwrite(img,fullfile(path_to_folder,[num2str(num_curr_imgs+1) '_mask.jpg']));
imwrite(img2,fullfile(path_to_folder,[num2str(num_curr_imgs+2) '_mask.jpg']));
imwrite(img3,fullfile(path_to_folder,[num2str(num_curr_imgs+3) '_mask.jpg']));
imwrite(img4,fullfile(path_to_folder,[num2str(num_curr_imgs+4) '_mask.jpg']));
