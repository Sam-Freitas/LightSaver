...
for augmentation_P in [0.25,0.5,0.75,0.9,1.00]:#[0.00,0.001,0.01,0.1,0.25]:
    augmentation_P = round(augmentation_P,6)
    ...
    print(exec(open("scripts_python/network_testing/plotting_batches.py").read()))
